# Contributing to Deno-Lit-Typescript-Starter
...
1. Search [GitHub](https://github.com/njfamirm/Deno-Lit-Typescript-Starter/pulls) for an open or closed PR that relates to your submission.
...
4. [Fork](https://docs.github.com/en/github/getting-started-with-github/fork-a-repo) the njfamirm/Deno-Lit-Typescript-Starter repo.
...
11. In GitHub, send a pull request to `Deno-Lit-Typescript-Starter:main`.
