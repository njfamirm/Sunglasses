...
export default class PageHome extends LitElement {
  ...
  override render(): TemplateResult {
    return html`
      <header>
        <a href="/">
          <svg class="logo" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink"
            xmlns:svgjs="http://svgjs.com/svgjs" width="512" height="512" x="0" y="0" viewBox="0 0 60 60" xml:space="preserve"
            class="">
            <g>
        ...
        <ul>
          ...
          <li><svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink"
              xmlns:svgjs="http://svgjs.com/svgjs" x="0" y="0" viewBox="0 0 48 48" xml:space="preserve"
      ...
      <footer>
          <a class="icon-link" title="view preoject source" href="https://github.com/njfamirm/Sunglasses" target="_blank">
            <svg class="icon" title="Find on github" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
              <path
          ...
          <a class="icon-link" title="Amir Najafi's twitter" href="https://twitter.com/njfamirm" target="_blank">
            <svg class="icon" viewBox="0 0 24 24" focusable="false" role="presentation" class="css-1im46kq">
